package ru.prooftechit.smh.configuration.db;
...
public class DatabaseCreator {
    ...
    public void createDatabase() {
        ...
        // Соответственно если для роли smarthouse нет базы smarthouse (а для такого случая и написан данный класс) - будет брошено исключение
